...
#
get_filename_component(filename "/Users/maxine/Downloads/Quant_Dev/try/build/_deps/date_src-subbuild/date_src-populate-prefix/src/v3.0.3.tar.gz" ABSOLUTE)
get_filename_component(directory "/Users/maxine/Downloads/Quant_Dev/try/build/_deps/date_src-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-date_src-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-date_src-populate${i}")
